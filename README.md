...
[![dsh](https://img.shields.io/badge/dsh-0.1.1--rc.x%20%7C%200.1.2%20%7C%200.1.5--29abe2)](https://github.com/deepseek-ai/deepseek-harness)
...
- DSH **Web profile** on the current plugin contract (validated against `dsh` 0.1.1-rc.2, 0.1.2-rc.1 and 0.1.5-rc.2); the plugin only registers in the Web UI.
